...
## Arm controller parameters
    ...
    safety_zone_boundaries = [-0.068, 0.619, -0.278, 1.130] # [x_min, x_max, y_min, y_max] #rectangular non allowed region 

    safety_zone_allowed1_boundaries= [-0.145, 0.294 , -0.388, -0.02] # [x_min, x_max, y_min, y_max] #rectangular allowed region - package 1

    safety_zone_allowed2_boundaries= [0.334, 0.711, 0.221, 0.626] # [x_min, x_max, y_min, y_max] #rectangular allowed region - package 2

    safety_zone_allowed3_boundaries= [-0.02, 0.429, 0.84, 1.277] # [x_min, x_max, y_min, y_max] #rectangular allowed region - package 3
