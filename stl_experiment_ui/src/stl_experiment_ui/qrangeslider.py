...
class Head(Element):
    ...
    def drawText(self, event, qp):
        ...
        qp.drawText(event.rect(), QtCore.Qt.AlignLeft, str(self.main.min()/10.0))
...
class Tail(Element):
    ...
    def drawText(self, event, qp):
        qp.setPen(self.textColor())
        qp.setFont(QtGui.QFont('Arial', 10))
        qp.drawText(event.rect(), QtCore.Qt.AlignRight, str(self.main.max()/10.0))
...
class Handle(Element):
    ...
    def drawText(self, event, qp):
        qp.setPen(self.textColor())
        qp.setFont(QtGui.QFont('Arial', 10))
        qp.drawText(event.rect(), QtCore.Qt.AlignLeft, str(self.main.start()/10.0))
        qp.drawText(event.rect(), QtCore.Qt.AlignRight, str(self.main.end()/10.0))
...
class QRangeSlider(QtWidgets.QWidget, Ui_Form):
    ...
    def __init__(self, parent=None):
        ...
        self.handle.setTextColor((119, 255, 255))
...
if __name__ == '__main__':
    ...
    rs.handle.setStyleSheet('background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #7ff, stop:1 #7ff);')
    app.exec_()